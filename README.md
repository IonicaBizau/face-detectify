...
```sh
# Using npm
npm install --global face-detectify

# Using yarn
yarn global add face-detectify
```


Then, run `face-detectify --help` and see what the CLI tool can do.


```
$ face-detectify --help
Usage: face-detectify [options]
...
Documentation can be found at https://github.com/IonicaBizau/face-detectify#readme.
```
